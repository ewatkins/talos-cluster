...
| App | Description |
| --- | --- |
| [crunchy-postgres-operator](crunchy-postgres-operator/README.md) | PGO operator (v6.0.0) managing two HA PostgreSQL 16 clusters: a general-purpose 3-replica cluster with PgBouncer and pgBackRest backups to NFS/Garage/R2, and a VectorChord-enabled cluster for Immich |
