...
| App | URL | Description |
| --- | --- | --- |
| [bazarr](bazarr/README.md) | `bazarr.ewatkins.dev` | Automatic subtitle downloader and manager for the media library || [immich](immich/README.md) | `photos.ewatkins.dev` | Self-hosted photo and video backup with face recognition and smart search |
